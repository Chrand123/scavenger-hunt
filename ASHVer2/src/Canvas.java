...
public class Canvas extends JComponent {
	...
	public Canvas(int width, int height) {
		...
		this.HEIGHT = height;
		this.board = null;
		menu_background = new ImageIcon(getClass().getResource("/images/menu_background.jpg")).getImage();
		menu_background = resizeImage(menu_background, Main.WIDTH, Main.HEIGHT);
		
		int rankSize = 30;
		rank1 = new ImageIcon(getClass().getResource("/images/1st.png")).getImage();
		rank1 = resizeImage(rank1, rankSize, rankSize, 4);
		rank2 = new ImageIcon(getClass().getResource("/images/2nd.png")).getImage();
		rank2 = resizeImage(rank2, rankSize, rankSize, 4);
		rank3 = new ImageIcon(getClass().getResource("/images/3rd.png")).getImage();
		rank3 = resizeImage(rank3, rankSize, rankSize, 4);
		rank4 = new ImageIcon(getClass().getResource("/images/4th.png")).getImage();
